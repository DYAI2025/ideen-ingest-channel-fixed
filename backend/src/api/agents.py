...
async def enrich_idea(idea_id: str, enrichment: IdeaEnrichment) -> Dict[str, Any]:
    ...
    try:
        ...
        logger.info(f"Idea {idea_id} enriched by agent with {len(enrichment.products)} product ideas")
    ...
    try:
        ...
        return {
            ...
            'stats': {
                ...
                'enrichment_rate': f"{(enriched_count / total_ideas * 100):.1f}%" if total_ideas > 0 else "0%",
